...
public class DudeFull extends Moveable implements Transformable, Executeable{
    private int resourceLimit;
    public DudeFull(String id, Point position, List<PImage> images, int health, int actionPeriod, int animationPeriod,int resourceLimit) {
